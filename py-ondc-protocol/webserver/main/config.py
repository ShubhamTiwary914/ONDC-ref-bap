...
class Config:
    ...
    VERIFICATION_ENABLE = False #os.getenv("VERIFICATION_ENABLE", "True") == "True"
...
class PreProductionConfig(Config):
    ...
    MONGO_DATABASE_PORT = int(os.getenv("MONGO_DATABASE_PORT", 27017))
    MONGO_DATABASE_NAME = os.getenv("MONGO_DATABASE_NAME", "sandbox_bap")
    CLIENT_WEBHOOK_ENDPOINT = os.getenv("CLIENT_WEBHOOK_ENDPOINT", "http://localhost:3000/clientApis/response")
