...
from main.utils.cryptic_utils import create_authorisation_header, verify_authorisation_header
...
def add_search_catalogues(bpp_response):
    ...
    if is_successful:
        log("\n\nSuccessful entry: Sending Response to Client Webhook!\n\n")
...
def gateway_search(search_request):
    ...
    log(f"\n\nMaking request to bg or bpp with {search_request}\n\n\n")
